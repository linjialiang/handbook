...
路径： /usr/lib/systemd/system/phpfpm-8.0.service

官方案例： /package/lnmp/php-8.0.14/build_php/sapi/fpm/php-fpm.service
...
[Service]
Type=simple
PIDFile=/server/run/php/phpfpm-8.0.pid
ExecStart=/server/php/8.0/sbin/php-fpm --nodaemonize --fpm-config /server/php/8.0/etc/php-fpm.conf
...
[Service]
Type=simple
PIDFile=/server/php/8.0/var/run/php-fpm.pid
ExecStart=/server/php/8.0/sbin/php-fpm --nodaemonize --fpm-config /server/php/8.0/etc/php-fpm.conf
ExecReload=/bin/kill -USR2 $MAINPID
